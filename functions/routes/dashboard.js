...
router.get('/coordenador', verificarToken, verificarPerfil('coordenador', 'super_admin'), async (req, res) => {
  try {
    ...
    // Busca todas as submissões dos cursos
    ...
    // Filtra submissões dos cursos do coordenador
    ...
    for (const cursoId of cursoIds) {
      ...
      const regrasDoCurso = Object.values(regras).filter(r => r.curso_id === cursoId).map(r => r);
